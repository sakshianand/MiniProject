...
<body>
    ...
    <div class="nav-wrapper">
      ...
      <li><a href="vieworder.php">View Orders</a></li>
       <li><a href="commentseller.php">See Reviews</a></li>
...
<div class="row">
        <a href="add.html"><div class="col s12 m6">
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title valign" ><h5 class="center-align">Add Products</h5></span>
        ...
        <div class="col s12 m6">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title"><h5 class="center-align">View Products</h5></span>
