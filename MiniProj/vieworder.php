...
<div class="container">
<?php $sql = "select * from orderplace where seller ='{$_SESSION['reg']}'";
      $res = mysqli_query($conn,$sql);
      //$tow= mysqli_fetch_array($res);
      $tow =  mysqli_fetch_array($res); 
  echo'<h2> Hi '; echo $tow['sellername']; echo'. Orders received By You';echo'</h2>';
  ...
  echo'<div class="panel-group">';
    ...
    echo'<div class="panel panel-default">
     ...
     echo' <pre><div class="panel-heading"><b>'; echo'Customer Contact Number: ';echo'</b>'; 
                          
                          
                          echo $row['customercont'];         echo'</div></pre>';
													echo' <pre><div class="panel-heading"><b>'; echo'Price ';echo'</b>'; 
													
													
													echo $row['price'];         echo'</div></pre>';
   echo '</div>
